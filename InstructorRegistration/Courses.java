...
public class Courses {
    ...
    // the constructor classes for the courses class; they include mandatory
    // information about the course such as the title, name, description and refund
    // status
    public Courses() {
        title = null;
        name = null;
    ...
    // edits the title to be reflected in the website, does not need to return any
    // object
    ...
    // the course will have either a true or false flag for its refund status; if
    // true then the student can apply for a refund after quitting the course; else,
    // the student
    ...
    // questions are stored in question lists which can be called to display the
    ...
    // the videoFile variable is listed as a string to denote the file name, in
    // actual application, it would be the specific file type; the fileList array
